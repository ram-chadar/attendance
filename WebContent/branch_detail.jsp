...
%>
  <div class="container">
    <section class="register">
      ...
      <form method="post" action="branchdtl">
<%--       <h1 style="color:red">${msg}</h1>  
 --%>      
      <div class="reg_section personal_info">
    	  <h3>Branch Name</h3>
    	  
    	  <input type="text" name="bn" value="" placeholder="Short Name" required="required">
      ...
      <div class="reg_section password">
     	   <h3>Subject</h3>
     	    	<input type="text" name="subname" value="" placeholder="Subject Name" required="required">
           ...
           <p class="submit"><input type="submit" name="action" value="Add">
